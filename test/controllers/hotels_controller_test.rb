...
class HotelsControllerTest < ActionDispatch::IntegrationTest
  ...
  #     post hotels_url, params: { hotel: { description: @hotel.description, name: @hotel.name } }
  #   end
  ...
  #   patch hotel_url(@hotel), params: { hotel: { description: @hotel.description, name: @hotel.name } }
